...
World1thru6TitleCard:
	.db $FB, $FB, $FB, $80, $82, $84, $86, $88, $8A, $8C, $8E, $90, $92, $FB, $FB, $FB
	.db $FB, $FB, $FB, $81, $83, $85, $87, $89, $8B, $8D, $8F, $91, $93, $FB, $FB, $FB ; $10
	.db $FB, $FB, $FB, $A0, $A2, $A4, $A6, $A8, $AA, $AC, $AE, $B0, $B2, $FB, $FB, $FB ; $20
	.db $FB, $FB, $FB, $A1, $A3, $A5, $A7, $A9, $AB, $AD, $AF, $B1, $B3, $FB, $FB, $FB ; $30
	.db $FB, $FB, $FB, $C0, $C2, $C4, $C6, $C8, $CA, $CC, $CE, $B4, $B6, $FB, $FB, $FB ; $40
	.db $FB, $FB, $FB, $C1, $C3, $C5, $C7, $C9, $CB, $CD, $CF, $B5, $B7, $FB, $FB, $FB ; $50
	.db $FB, $FB, $FB, $B8, $BA, $BC, $BE, $F2, $F4, $E0, $E1, $E3, $E4, $FB, $FB, $FB ; $60
	.db $FB, $FB, $FB, $B9, $BB, $BD, $BF, $F3, $F5, $E6, $E7, $EA, $EF, $FB, $FB, $FB ; $70
	.db $FB, $FB, $FB, $94, $96, $98, $9A, $9C, $9E, $95, $97, $99, $9B, $FB, $FB, $FB ; $80
...
TitleCardText:
	...
	; WORLD  1-1
	.db $25, $8C, $0B
	.db $56, $58, $5A, $5C, $FB, $57, $59, $5B, $D1, $FB, $D1
	; EXTRA LIFE...  0
	.db $23, $48, $10
	.db $DE, $F1, $ED, $EB, $DA, $FD, $E5, $E2, $DF, $DE
	.db $F9, $F9, $F9, $FD, $FD, $D0
	.db $00
